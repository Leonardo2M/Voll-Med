...
class MedicoRepositoryTest {
	...
	@Test
	@DisplayName("Devolver null quando medico cadastrado não está disponivel na data")
	void escolherMedicoDisponivelCenario1() {

		var proximaSegundaAs10 = LocalDate.now().with(TemporalAdjusters.next(DayOfWeek.MONDAY)).atTime(10, 0);
		var medicoLivre = repository.escolherMedicoDisponivel(Especialidade.CARDIOLOGIA, proximaSegundaAs10);
	...
	@Test
	@DisplayName("Devolver um medico quando estiver disponivel")
	void escolherMedicoDisponivelCenario2() {
